...
export default function HomePage() {
	...
	return (
		<section className="relative mx-auto flex max-w-5xl flex-col items-center gap-10 px-6 pb-24 pt-20 text-center md:pt-32">
			<div className="space-y-6 max-w-3xl">
				<h1 className="text-5xl font-bold leading-tight tracking-tight md:text-7xl">{brand.slogan}</h1>
				<p className="mx-auto max-w-xl text-xl text-muted-foreground leading-relaxed">{brand.summary}</p>
			...
			<div className="relative mt-12 w-full max-w-[280px]">
				<div className="absolute inset-0 -z-10 bg-gradient-to-tr from-indigo-500/30 to-purple-500/30 blur-3xl" />
				<div className="overflow-hidden rounded-[2.5rem] border-[6px] border-slate-900 bg-slate-900 shadow-2xl">
